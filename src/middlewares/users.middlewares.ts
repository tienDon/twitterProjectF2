      ...
      email: {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            req.user = user //giữ giùm cái user
            return true
          }
        }
      },
      ...
      Authorization: {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            //nếu xuống dc đây thì tức là access_token có rồi
      ...
      email_verify_token: {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            try {
              //verify email_verify_token để lấy decoded email verify_token
              ...
              //nếu có user thì xem thử user này có bị banned ko?
    ...
    email: {
      ...
      custom: {
        options: async (value, { req }) => {
          ...
          if (!user) {
            throw new ErrorWithStatus({
              message: USERS_MESSAGES.USER_NOT_FOUND, //422
              status: HTTP_STATUS.NOT_FOUND
            })
          }
          //đến đâu thì oke
  ...
  checkSchema(
    {
      forgot_password_token: {
        ...
        custom: {
          options: async (value, { req }) => {
            //nếu ko truyền lên forgot_password_token thì báo lỗi
            if (!value) {
              throw new ErrorWithStatus({
            ...
            try {
              //verify forgot_password_token để lấy decoded forgot_password_token
